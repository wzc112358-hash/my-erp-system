...
export const SOURCE_STRATEGIES = {
  中石油招投标网: {
    ...
    manualAssistReason: '公开入口为 JS 应用；登录详情、验证码、买标书或附件下载需要人工协助。',
  },
  云梦泽询价网: {
  ...
  易派克: {
    ...
    crawlStrategy: CRAWL_STRATEGIES.PLAYWRIGHT_NETWORK,
    siteSearchBehavior: SITE_SEARCH_BEHAVIORS.SUPPLEMENTAL,
    manualAssistReason: '账号内容、8位码和材料详情需要人工协助确认。',
  },
  延长石油: {
    ...
    siteSearchBehavior: SITE_SEARCH_BEHAVIORS.SUPPLEMENTAL,
    manualAssistReason: '部分入口不稳定，失败时保留错误证据并提醒负责人。',
  },
  中化: {
    categoryNames: ['招标公告', '采购公告', '竞价公告'],
    crawlStrategy: CRAWL_STRATEGIES.PLAYWRIGHT_NETWORK,
    siteSearchBehavior: SITE_SEARCH_BEHAVIORS.SUPPLEMENTAL,
    manualAssistReason: 'JS 应用优先发现网络接口；站内标题搜索只作补充。',
  },
  国能网: {
    categoryNames: ['国能E招-招标公告', '国能E招-非招标公告', '国能E购-询价采购公告', '国能E购-竞价公告', '国能E购-竞争性谈判公告'],
    categoryUrls: ['https://www.chnenergybidding.com.cn/bidweb/001/001002/moreinfo.html', 'https://neep.shop/html/portal/index-Inquiries.html'],
  ...
  中海油: {
    ...
    crawlStrategy: CRAWL_STRATEGIES.PLAYWRIGHT_NETWORK,
    siteSearchBehavior: SITE_SEARCH_BEHAVIORS.SUPPLEMENTAL,
    manualAssistReason: 'JS 应用；登录或附件详情需要人工协助。',
  },
  裕龙招投标网: {
...
export const resolveSourceStrategy = (source) => {
  ...
  return {
    ...
    manualAssistReason: source.manual_assist_reason || configured.manualAssistReason || '',
