...
const MENU_CONFIG: Record<UserRole, MenuConfig[]> = {
  sales: [
    ...
    { key: 'opportunities', label: '招投标信息', icon: <RadarChartOutlined />, path: '/sales/opportunities' },
  ...
  purchasing: [
    ...
    { key: 'opportunities', label: '招投标信息', icon: <RadarChartOutlined />, path: '/purchase/opportunities' },
