...
export const ContractList: React.FC = () => {
  ...
  const filteredData = useMemo(() => {
    ...
    return data.filter((contract) => {
      const hasRelation = hasPurchaseContractRelation(contract, salesContracts);
  ...
  }, [data, relationFilter, salesContracts, search, status]);
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_: unknown, record: PurchaseContract) => {
        const hasRelation = hasPurchaseContractRelation(record, salesContracts);
    ...
    },
    {
      ...
      render: (_: unknown, record: PurchaseContract) => (
        <Space size="small">
          ...
          {!hasPurchaseContractRelation(record, salesContracts) && (
            <Tooltip title="关联合同">
              <Button
                type="text"
                icon={<LinkOutlined />}
